...
**Note for platform developers.** This file mirrors the production prompt in [`docs/05-prompt-analyst.md`](../../docs/05-prompt-analyst.md). Any edit here must be reflected in the source document, otherwise prompt testing is meaningless. Record run results in the prompt test log in [`docs/13-agent-tooling.md`](../../docs/13-agent-tooling.md).
