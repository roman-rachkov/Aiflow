...
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/02-architecture.md`        | Chat SSE long-work still described as Next-only in places; live path is `chat:run` worker + Redis→SSE bridge (D0g, 2026-08-10). Full prose rewrite deferred.                                                                                                         |
