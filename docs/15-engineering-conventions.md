...
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs/10-infrastructure.md`      | Top **YAML sample** flagged prod/future (2026-08-08) and the project-layout tree corrected (no Dockerfiles exist yet). **Still open:** the YAML sample itself still models `build:` images / multi-stage Dockerfiles and does not match the live `docker-compose.yml` — full rewrite deferred until prod Dockerfiles land. |
