...
- **Acceptance tooling**: ESLint, Prettier, TypeScript, Prisma validate (run automatically after code generation).
...
- Sandboxes run sequentially within a single project (to avoid Git conflicts), but in parallel across projects.
