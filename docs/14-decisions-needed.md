...
| Port allocation         | App 3000, model-router 3001, Gitea 3002 (container-internal 3000), Langfuse UI 3100 (MVP-3 B1)                                                                                                         | [10-infrastructure.md](10-infrastructure.md); B1 2026-08-23        |
...
| Prisma in sandbox       | Validate only in sandbox; apply schema at deploy via `db push` into `app_{hex}` (never onto `project_{uuid}`)                                                                                          | [12](12-open-questions.md) #2 2026-08-07                           |
